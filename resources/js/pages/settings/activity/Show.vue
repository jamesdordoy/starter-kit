            ...
            <div class="space-y-8">
                <div class="rounded-lg border border-neutral-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <div class="p-6">
                            ...
                            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        {{ activity.data[0].formatted_created_at }}
                                    </p>
                                </div>
                                <div class="flex items-center gap-2">
                                    ...
                                    >
                                        {{ activity.data[0].log_name }}
                                    </span>
                                    <span
                                        v-if="activity.data[0].causer"
                                    ...
                                    >
                                        By {{ activity.data[0].causer.name }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Changes Section -->
                        <div v-if="activity.data[0].properties" class="space-y-6">
                            <!-- File Upload Specific Display -->
                            <div
                                v-if="activity.data[0].log_name === 'media_added'"
                            ...
                            >
                                ...
                                <div class="space-y-4">
                                    <div v-for="(value, key) in activity.data[0].properties" :key="key" class="flex items-center gap-2">
                            ...
                            <div v-if="activity.data[0].properties.changes" class="space-y-4">
                                <div
                                    v-for="(changes, field) in activity.data[0].properties.changes"
                                    :key="field"
                                    class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900"
                                >
                            ...
                            <div
                                v-if="Object.keys(activity.data[0].properties).length > 0"
                                class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900"
                            >
                                <h4 class="mb-3 text-sm font-medium text-gray-900 dark:text-gray-100">Additional Details</h4>
                                <div class="space-y-4">
                                    <div v-for="(value, key) in activity.data[0].properties" :key="key" class="flex items-start gap-2">
                                        <div class="flex flex-col">
                                            <span class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ formatFieldName(key) }}</span>
                                            <span class="text-sm text-gray-900 dark:text-gray-100">{{ formatValue(value) }}</span>
                                        </div>
                        ...
                        <!-- No Changes Message -->
                        <div
                            v-if="!activity.data[0].properties || Object.keys(activity.data[0].properties).length === 0"
                            class="rounded-lg border border-gray-200 bg-gray-50 p-4 text-center dark:border-gray-700 dark:bg-gray-900"
                        >
