...
<template>
  <div class="flex gap-2 items-center">
    ...
    >
      <SwitchThumb
        class="w-3.5 h-3.5 my-auto bg-black dark:bg-white text-xs flex items-center justify-center shadow-xl rounded-full transition-transform translate-x-0.5 will-change-transform data-[state=checked]:translate-x-full"
      />
    </SwitchRoot>
  </div>
</template>