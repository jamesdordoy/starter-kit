                ...
                <div class="overflow-hidden bg-white shadow dark:bg-gray-800 sm:rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="mb-6 border-b border-gray-200 pb-4 dark:border-gray-700">
                            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span v-if="activity.data.causer" class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10 dark:bg-gray-400/10 dark:text-gray-400">
                        ...
                        <div v-if="activity.data.properties" class="space-y-6">
                            ...
                            <div v-if="activity.data.log_name === 'media_added'" class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
                            ...
                            <div v-if="activity.data.properties.changes" class="space-y-4">
                                <div v-for="(changes, field) in activity.data.properties.changes" :key="field" class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
                            ...
                            <div v-if="Object.keys(activity.data.properties).length > 0" class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
                        ...
                        <!-- No Changes Message -->
                        <div v-if="!activity.data.properties || Object.keys(activity.data.properties).length === 0" class="rounded-lg border border-gray-200 bg-gray-50 p-4 text-center dark:border-gray-700 dark:bg-gray-800/50">
